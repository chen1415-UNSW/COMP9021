...
parser.add_argument('--file',dest = 'filename',required = False)
parser.add_argument('-print',dest = 'print_file',action = 'store_true',default = False,required=False)
args = parser.parse_args()
if not args.filename:
        print('I expect --file followed by filename and possibly -print'+ \
...
# find all points with value 1 and change it                
...
'''
feng diao hong dian XXXXXX
'''
L_cul_de = sorted(L_cul_de)
##print('L_cul_de: ',L_cul_de)
...
##print('L_route_row ', L_route_row)
#print('L_route_col ',L_route_col)
